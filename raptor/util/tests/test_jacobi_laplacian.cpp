...
TEST(AnisoJacobiTest, TestsInUtil)
{
    ...
    const char* x_ones_1 = "../../../../test_data/laplace_jacobi_ones_1.txt";
    const char* x_ones_2 = "../../../../test_data/laplace_jacobi_ones_2.txt";
    const char* x_inc_1 = "../../../../test_data/laplace_jacobi_inc_1.txt";
    const char* x_inc_2 = "../../../../test_data/laplace_jacobi_inc_2.txt";
