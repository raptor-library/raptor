...
int main(int _argc, char** _argv)
{
    ...
    if (mat == 1)
    {
        //strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs256/p");
        //strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs512/p");
        //strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs1024/p");
        //strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs2048/p");
        //strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs4096/p");
        strcpy(filename, "../../../../../modelling_output/mfem_dg_diffusion/3step/procs8192/p");
    }
    else if (mat == 2)
    {
        //strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs256/p");
        //strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs512/p");
        //strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs1024/p");
        //strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs2048/p");
        //strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs4096/p");
        strcpy(filename, "../../../../../modelling_output/g3circuit/3step/procs8192/p");
    }
    else if (mat == 3)
    {
        //strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs256/p");
        //strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs512/p");
        //strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs1024/p");
        //strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs2048/p");
        //strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs4096/p");
        strcpy(filename, "../../../../../modelling_output/hook1498/3step/procs8192/p");
    }
    ...
    FILE *f;
    f = fopen(filename, "w");
    // Comm for gathering messages to send off node 
    fprintf(f, "local_S_par_comm\n"); 
    print_all_messages(A->tap_comm->topology, A->tap_comm->local_S_par_comm->send_data, f);
