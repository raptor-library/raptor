...
/* UPDATE THIS METHOD TO USE A-ORTHO METHODS */
void SRE_CG(CSRMatrix* A, Vector& x, Vector& b, int t, aligned_vector<double>& res, double tol, int max_iter)
{
    Vector r;
    Vector p;
    Vector Ap;
...
void SRE_CG2(CSRMatrix* A, Vector& x, Vector& b, int t, aligned_vector<double>& res, double tol, int max_iter){
    return;
}
