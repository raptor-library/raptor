...
int main(int _argc, char** _argv)
{
    ...
    //const char* mat = "../../../../../mtx_market_matrices/Hook_1498.pm";
    const char* mat = "../../../../../mtx_market_matrices/mfem_dg_diffusion_331.pm";
    // Residual output filenames
    //const char* res_filename = "Hook_1498_ecg_5.txt";
    const char* res_filename = "mfem_10.txt";
    ...
    //CG(A, x, b, residuals, 1e-3, max_iter);
