...
void CG(ParCSRMatrix* A, ParVector& x, ParVector& b, aligned_vector<double>& times, aligned_vector<double>& res, double tol, int max_iter)
{
    double start, stop;
...
void SRECG(ParCSRMatrix* A, ParVector& x, ParVector& b, int t, aligned_vector<double>& times, aligned_vector<double>& res, double tol, int max_iter)
{
    double start, stop;
